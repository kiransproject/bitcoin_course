...
public class Transaction {
    ...
    public class Input {
        ...
        public int hashCode() {
            int hash = 1;
            hash = hash * 17 + Arrays.hashCode(prevTxHash); // i think 17 is used for randomness
            hash = hash * 31 + outputIndex; // 31 is used as the multiplier as its multplication can be replaced by a bitwise shift which is faster than standard multiplication ( bitwise shift of 5) - https://www.baeldung.com/java-hashcode
    ...
    public Transaction(double coin, PublicKey address) {
        ...
        finalize(); // see method on line 245
    }
