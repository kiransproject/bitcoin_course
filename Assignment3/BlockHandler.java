...
public class BlockHandler {
    ...
    public Block createBlock(PublicKey myAddress) {
        ...
        Transaction[] txs = txPool.getTransactions().toArray(new Transaction[0]); // the 0 represents the size of the arraylist being converted - https://stackoverflow.com/questions/174093/toarraynew-myclass0-or-toarraynew-myclassmylist-size
