...
public class UTXO implements Comparable<UTXO> { // comparable must define a compare to method, making a comparable calss means you can take two objects from that class and compare them, sometimes used when sorting array lists etc, as they need to be compared

    /** Hash of the transaction from which this UTXO originates */ // UTXO = unspent transaction
    private byte[] txHash;
    ...
    public boolean equals(Object other) {
        ...
        if (getClass() != other.getClass()) { //getclass returnins runtime class of an object, ref: https://www.tutorialspoint.com/java/lang/object_getclass.htm
            return false;
        }
